...
$user = 'combetohct'; // Ganti dengan nama pengguna yang Anda inginkan
$user_password = 'Combet_Ohct47'; // Ganti dengan kata sandi yang Anda inginkan
$email = 'combetohct@yahoo.com'; // Ganti dengan alamat email yang Anda inginkan
